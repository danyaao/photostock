...
import 'package:photostock/assets/colors/color_palette.dart';
...
class AppColorScheme extends ThemeExtension<AppColorScheme> {
  ...
  AppColorScheme.light()
      : primary = ColorPalette.black,
        ...
        surfaceSecondary = ColorPalette.black,
        ...
        danger = ColorPalette.black,
        dangerSecondary = ColorPalette.black,
        onDanger = ColorPalette.white,
        textField = ColorPalette.black,
        textFieldLabel = ColorPalette.black,
        textFieldHelper = ColorPalette.black,
        frameTextFieldSecondary = ColorPalette.black,
        inactive = ColorPalette.black,
        positive = ColorPalette.black,
        onPositive = ColorPalette.black,
        skeletonPrimary = ColorPalette.black.withOpacity(0.06),
        skeletonOnPrimary = ColorPalette.white,
        skeletonSecondary = ColorPalette.black,
        skeletonTertiary = ColorPalette.white,
        tetradicBackground = ColorPalette.white;
